...
declare -A GSETTINGS_VALUES=(
    ...
    ["org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Utilities/ apps"]="['org.gnome.FileRoller.desktop', 'org.gnome.Calculator.desktop', 'org.gnome.Cheese.desktop', 'org.gnome.Connections.desktop', 'ca.desrt.dconf-editor.desktop', 'org.gnome.DiskUtility.desktop', 'org.gnome.baobab.desktop', 'simple-scan.desktop', 'org.gnome.Evince.desktop', 'org.fedoraproject.MediaWriter.desktop', 'org.gnome.font-viewer.desktop', 'yelp.desktop', 'org.gnome.eog.desktop', 'nvidia-settings.desktop', 'org.freedesktop.GnomeAbrt.desktop', 'org.gnome.Settings.desktop', 'gnome-system-monitor.desktop', 'org.gnome.TextEditor.desktop', 'org.gnome.tweaks.desktop']"
    ...
    ["org.gnome.shell app-picker-layout"]="[{'Games': <{'position': <0>}>, 'Emulators': <{'position': <1>}>, 'Utilities': <{'position': <2>}>, 'org.gnome.Boxes.desktop': <{'position': <3>}>, 'com.mattjakeman.ExtensionManager.desktop': <{'position': <4>}>, 'org.filezillaproject.Filezilla.desktop': <{'position': <5>}>, 'org.gimp.GIMP.desktop': <{'position': <6>}>, 'io.github.benjamimgois.goverlay.desktop': <{'position': <7>}>, 'org.inkscape.Inkscape.desktop': <{'position': <8>}>, 'org.onlyoffice.desktopeditors.desktop': <{'position': <9>}>, 'net.davidotek.pupgui2.desktop': <{'position': <10>}>, 'com.prusa3d.PrusaSlicer.desktop': <{'position': <11>}>, 'com.prusa3d.PrusaSlicer.GCodeViewer.desktop': <{'position': <12>}>, 'org.qbittorrent.qBittorrent.desktop': <{'position': <13>}>, 'org.thentrythis.Samplebrain.desktop': <{'position': <14>}>, 'com.steamgriddb.SGDBoop.desktop': <{'position': <15>}>, 'com.github.theironrobin.siglo.desktop': <{'position': <16>}>, 'com.steamgriddb.steam-rom-manager.desktop': <{'position': <17>}>, 'tiny-media-manager.desktop': <{'position': <18>}>, 'com.github.Eloston.UngoogledChromium.desktop': <{'position': <19>}>}]"
    ["org.gnome.shell favorite-apps"]="['org.gnome.Nautilus.desktop', 'io.gitlab.librewolf-community.desktop', 'org.signal.Signal.desktop', 'org.jitsi.jitsi-meet.desktop', 'com.vscodium.codium.desktop', 'com.jetbrains.PyCharm-Professional.desktop', 'com.jetbrains.Rider.desktop', 'steam.desktop', 'dev.alextren.Spot.desktop', 'io.freetubeapp.FreeTube.desktop', 'org.videolan.VLC.desktop', 'org.gnome.Terminal.desktop', 'org.gnome.Software.desktop']"
