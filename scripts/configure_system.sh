...
declare -A GSETTINGS_VALUES=(
    ...
    ["org.gnome.shell app-picker-layout"]="[{'Games': <{'position': <0>}>, 'Emulators': <{'position': <1>}>, 'Utilities': <{'position': <2>}>, 'org.gnome.Boxes.desktop': <{'position': <3>}>, 'com.mattjakeman.ExtensionManager.desktop': <{'position': <4>}>, 'org.filezillaproject.Filezilla.desktop': <{'position': <5>}>, 'org.gimp.GIMP.desktop': <{'position': <6>}>, 'io.github.benjamimgois.goverlay.desktop': <{'position': <7>}>, 'org.inkscape.Inkscape.desktop': <{'position': <8>}>, 'org.onlyoffice.desktopeditors.desktop': <{'position': <9>}>, 'net.davidotek.pupgui2.desktop': <{'position': <10>}>, 'com.prusa3d.PrusaSlicer.desktop': <{'position': <11>}>, 'com.prusa3d.PrusaSlicer.GCodeViewer.desktop': <{'position': <12>}>, 'org.qbittorrent.qBittorrent.desktop': <{'position': <13>}>, 'org.thentrythis.Samplebrain.desktop': <{'position': <14>}>, 'com.steamgriddb.SGDBoop.desktop': <{'position': <15>}>, 'com.steamgriddb.steam-rom-manager.desktop': <{'position': <16>}>, 'tiny-media-manager.desktop': <{'position': <17>}>, 'org.nickvision.tubeconverter.desktop': <{'position': <18>}>, 'com.github.Eloston.UngoogledChromium.desktop': <{'position': <19>}>, 'io.gitlab.azymohliad.WatchMate.desktop': <{'position': <20>}>}]"
